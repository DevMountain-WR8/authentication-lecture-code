...
module.exports = {
    register: async(req, res) => {
        ...
        //Hash and salt the users password, insert their info into the db
    ...
    login: async(req, res) => {
        ...
        //Make sure the password matches the hashed value
        ...
        //Place the user on a session, and send the info client-side
